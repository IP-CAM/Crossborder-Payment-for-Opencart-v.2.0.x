...
<div class="buttons">
  <div class="pull-right">
    &nbsp;&nbsp;<input type="button" id="btn-globepayalipay-confirm" class="btn btn-primary" value="<?php echo $button_confirm ?>">
  </div>
</div>
  ...
  (function($) {
    ...
    $('#btn-globepayalipay-confirm').click(function() {
      ...
      $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
          $('#btn-globepayalipay-confirm').attr('disabled', 'disabled').val('<?php echo $button_loading ?>');
        },
        success: function(json) {
          if (json['info']) {
            $('#btn-globepayalipay-confirm').removeAttr('disabled').val('<?php echo $button_confirm ?>');
